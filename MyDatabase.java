...
public class MyDatabase {
	...
	public static String prompt = "AmrutaSql> ";
	...
	public static void select(String userInput) throws Exception {
		 ...
		 */
		CCJSqlParserManager parMngr = new CCJSqlParserManager();
		net.sf.jsqlparser.statement.Statement statement = null;
		try {
			statement = parMngr.parse(new StringReader(userInput));
	...
	private static void splashScreen() {
		...
		System.out.println("***********©2017 Amruta Folane*********");
	}
					...
					if(newStartContentOffset - currRecArrLoc > 2)
					{
						...
						for (int i = 0; i < columnValList.size(); i++) {
							...
							case"8":
								...
								break;
							case "9":
								rfl.writeDouble(Float.parseFloat(columnValList.get(i).get(1)));
								break;
							case "10":
